...
const string ObjectTags::ROW_QTY = "[ROW_QTY]";
const string ObjectTags::ROW_QTY_END = "[-ROW_QTY]";
const string ObjectTags::GAP_X = "[GAP_X]";
const string ObjectTags::GAP_X_END = "[-GAP_X]";
