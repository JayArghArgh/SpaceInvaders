#include "Invader2UpdateComponent.h"
#include "BulletSpawner.h"
#include "WorldState.h"
#include "SoundEngine.h"

void Invader2UpdateComponent::update(float fps)
{
	if (m_MovingRight)
	{
...
void Invader2UpdateComponent::dropDownAndReverse()
{
...
bool Invader2UpdateComponent::isMovingRight()
{
	return m_MovingRight;
}

void Invader2UpdateComponent::initialiseBulletSpawner(
